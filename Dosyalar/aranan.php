...
$gelen = $_POST["arama"];
$gelenyil = $_POST["yil1"];
$gelenyil2 = $_POST["yil2"];
$fiyat1 = $_POST["fiyat1"];
$fiyat2 = $_POST["fiyat2"];

$cek = $db->query("select * from araclar where onay='1' and aasec like '%$gelen%' ",PDO::FETCH_ASSOC);
$cek = $db->query("select * from araclar where onay='1' and ilyil like '%$gelenyil%' or ilyil like '%$gelenyil2%' ",PDO::FETCH_ASSOC);
$cek = $db->query("select * from araclar where onay='1' and parasi like '%$fiyat1%' or parasi like '%$fiyat2%' ",PDO::FETCH_ASSOC);
...
<div class="col-md-3">
<div class="former">
<a href="ilan.php?id='.$arac['id'].'">
<img src="'.$ek['sitelink'].'/yuklenen/'.$arac['resim'].'" alt="'.$ek['siteadi'].'" height="190">
<div class="durum">'.$arac['parasi'].' '.$arac['parasitl'].'</div>
<div class="fiyatil">
<div>
<span>'.$arac['marka'].'</span><br />
'.$arac['model'].'
</div>
<div style="text-align:right; line-height:16px;">
'.$arac['ilyil'].'<br>
'.$arac['suretler'].' - '.$arac['yanacaq'].'
</div>
</div>
</a>
</div>
